...
export function mapApifyGoogleMapsItem(item: Record<string, unknown>, city: string, state: string): NormalizedLead {
  ...
  const lead = {
    ...
    category: typeof item.categoryName === "string" ? item.categoryName : "outros",
    cnae: null,
